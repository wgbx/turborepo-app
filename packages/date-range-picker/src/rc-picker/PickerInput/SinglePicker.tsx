...
function Picker<DateType extends object = any>(props: PickerProps<DateType>, ref: React.Ref<PickerRef>) {
  // ========================= Prop =========================
  ...
  const {
    ...
    // Native
    onClick,
  } = filledProps as Omit<typeof filledProps, keyof ReplacedPickerProps<DateType>> & ReplacedPickerProps<DateType>
  ...
  const onInternalPickerValueChange = (dates: DateType[], info: BaseInfo & { source: 'reset' | 'panel'; mode: [PanelMode, PanelMode] }) => {
