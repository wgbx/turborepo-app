...
export default function MultipleDates<DateType extends object = any>(props: MultipleDatesProps<DateType>) {
  ...
  function renderSelector(content: React.ReactNode, onClose?: React.MouseEventHandler) {
    return (
      <span className={classNames(`${selectionCls}-item`)} title={typeof content === 'string' ? content : undefined}>
