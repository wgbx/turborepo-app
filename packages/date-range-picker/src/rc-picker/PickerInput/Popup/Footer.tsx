...
export default function Footer(props: FooterProps) {
  const { mode, internalMode, renderExtraFooter, showNow, showTime, onSubmit, onNow, invalid, needConfirm, generateConfig, disabledDate } =
    props
  ...
  const presetNode = showNow && (
    <li className={nowPrefixCls}>
      <a className={cls(nowBtnPrefixCls, nowDisabled && `${nowBtnPrefixCls}-disabled`)} aria-disabled={nowDisabled} onClick={onInternalNow}>
  ...
  return (
    <div className={cls(`${prefixCls}-footer`, classNames.popup.footer)} style={styles.popup.footer}>
