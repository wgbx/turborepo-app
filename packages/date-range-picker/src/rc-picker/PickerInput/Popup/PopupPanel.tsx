...
export default function PopupPanel<DateType extends object = any>(props: PopupPanelProps<DateType>) {
  ...
  if (multiplePanel) {
    return (
      <div className={`${prefixCls}-panels`}>
        ...
        >
          <PickerPanel<DateType> {...pickerProps} pickerValue={nextPickerValue} onPickerValueChange={onSecondPickerValueChange} />
        </PickerHackContext.Provider>
      </div>
    )
  }
